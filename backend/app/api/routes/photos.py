...
router.add_api_route(
    "/api/photos/{photo_id}", photo_handlers.update_photo, methods=["PATCH"], response_model=MessageResponse
)
router.add_api_route(
    "/api/photos/{photo_id}", photo_handlers.delete_photo, methods=["DELETE"], response_model=MessageResponse
)
router.add_api_route(
